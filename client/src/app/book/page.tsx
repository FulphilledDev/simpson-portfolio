...
// Map display labels to numeric enum values expected by the API
    ...
    try {
      await apiFetch("/api/appointments", {
        ...
        body: JSON.stringify({
          ...
          projectType: PROJECT_TYPE_ENUM_MAP[form.projectType],
      ...
      <div className="max-w-2xl mx-auto space-y-10">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-white/50 max-w-lg mx-auto leading-relaxed">
            Tell me about your project and I&apos;ll follow up to schedule a free call.
          </p>
        </div>
