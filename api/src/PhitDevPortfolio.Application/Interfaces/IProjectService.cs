...
public interface IProjectService
{
    ...
    Task<ProjectDto> CreateAsync(CreateProjectDto dto, Stream? thumbnailStream, string? thumbnailFileName, Stream? gifStream, string? gifFileName, CancellationToken ct = default);
    Task<ProjectDto?> UpdateAsync(int id, UpdateProjectDto dto, Stream? thumbnailStream, string? thumbnailFileName, Stream? gifStream, string? gifFileName, CancellationToken ct = default);
